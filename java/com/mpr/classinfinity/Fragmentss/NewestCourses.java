...
public class NewestCourses extends Fragment {
    ...
    private String JSON_QUERY_RELEVANCE = "https://www.udemy.com/api-2.0/courses/?page=1&page_size=20&ordering=newest";
    int page = 1, pageSize = 0;
    ArrayList<Courses> bookList;
    String tempStart = "https://www.udemy.com/api-2.0/courses/?page=", tempEnd = "&page_size=20&ordering=newest";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding.nestedScrollView.setOnScrollChangeListener(new NestedScrollView.OnScrollChangeListener() {
            ...
            public void onScrollChange(NestedScrollView v, int scrollX, int scrollY, int oldScrollX, int oldScrollY) {
                if (scrollY == v.getChildAt(0).getMeasuredHeight() - v.getMeasuredHeight()) {
                    ...
                    Log.i("Newest Courses", "Link: " + link);
        ...
        binding.search.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                tempStart = jsonStart;
                jsonStart += page;
                String jsonEnd = "&page_size=20&ordering=newest&search=";
    ...
    protected void updateUi(ArrayList<Courses> booksInfos) {
        ...
        CoursesItemAdapter sliderAdapter = new CoursesItemAdapter(booksInfos, binding.recyclerViewNewest, getContext(), R.layout.courses_item_specific, 2);
        binding.recyclerViewNewest.setAdapter(sliderAdapter);
        binding.recyclerViewNewest.setLayoutManager(new GridLayoutManager(getContext(), 2));
